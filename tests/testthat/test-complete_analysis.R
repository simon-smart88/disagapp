...
test_that("{shinytest2} recording: e2e_complete_analysis", {
  ...
  app <- shinytest2::AppDriver$new(app_dir = system.file("shiny", package = "disagapp"), name = "e2e_complete_analysis", timeout = 40000)
  ...
  mesh <- app$get_value(export = "mesh")
  expect_is(mesh[[1]], "inla.mesh")
