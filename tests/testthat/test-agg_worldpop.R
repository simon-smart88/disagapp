...
expect_error(agg_worldpop(lie_shape, country_code, "aaaa", "1km", 2012), "Method must be either \"Constrained\" or \"Unconstrained\"")
expect_error(agg_worldpop(lie_shape, country_code, "Constrained", "aaaa", 2020),"Resolution must be either \"100m\" or \"1km\"")
expect_error(agg_worldpop(lie_shape, country_code, "Constrained", "1km", 2012), "Constrained population data is only available for 2020")
expect_error(agg_worldpop(lie_shape, country_code, "Unconstrained", "1km", 1999), "Unconstrained data is only available between 2000 and 2020")
