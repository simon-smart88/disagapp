...
*disagapp* (v1.0.3) includes seven components, or steps of a possible workflow. Each component includes one or more modules, which are possible analyses for that step. Modules are classified using a colour coding depending system dependent on whether they <span class="module_mandatory">must be used</span>, <span class="module_choice">at least one of several choices must be used</span>, <span class="module_optional">or they are optional</span>.
...
- <span class="module_optional">Decrease covariate resolution</span>
