---
title: disagapp Session `r Sys.Date()`
---
...
Please find below the R code history from your *disagapp* v1.0.0 session. 
...
disagapp uses the following R packages that must be installed and loaded before starting.
```{r}
library(terra)
library(leaflet)
library(disagapp)
