...
transfer_covariates[["Nighttime light"]] <- cov_nightlight(new_shape, transfer_country, {{meta$cov_nightlight$year}})
```

```{r, echo = {{all(c(pred_transfer_knit, !is.null(meta$cov_water$used)))}}, include = {{all(c(pred_transfer_knit, !is.null(meta$cov_water$used)))}}}
transfer_covariates[["Distance to water"]] <-  cov_water(transfer_shape, transfer_country)
```
